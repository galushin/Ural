...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find, String, Strings_list)
{
    ...
    auto const r_str = s1.find(s2);
    auto const r_ural = fs1.find(fs2);

    BOOST_CHECK_EQUAL(r_str, r_ural);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_with_pos, String, Strings_list)
{
    ...
    auto const r_str = s1.find(s2, 3);
    auto const r_ural = fs1.find(fs2, 3);

    BOOST_CHECK_EQUAL(r_str, r_ural);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_fail, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2{"fan"};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_c_str, String, Strings_list)
{
    std::string s1{"Banana man"};
    char const * s2 = "an";
    ...
    auto const r_str = s1.find(s2, 3);
    auto const r_ural = fs1.find(s2, 3);

    BOOST_CHECK_EQUAL(r_str, r_ural);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_c_str_fail, String, Strings_list)
{
    std::string s1{"Banana"};
    char const * s2 = "fan";
    ...
    auto const r_str = s1.find(s2);
    auto const r_ural = fs1.find(s2);

    BOOST_CHECK_EQUAL(r_str, r_ural);
    BOOST_CHECK(r_ural == String::npos);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_char, String, Strings_list)
{
    std::string s1{"Banana man"};
    char c = 'n';
    ...
    auto const r_str = s1.find(c, 3);
    auto const r_ural = fs1.find(c, 3);

    BOOST_CHECK_EQUAL(r_str, r_ural);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_char_fail, String, Strings_list)
{
    std::string s1{"Banana"};
    char c = 'f';
    ...
    auto const r_str = s1.find(c);
    auto const r_ural = fs1.find(c);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
    ...
    auto const r_std = s1.find_last_of(s2);
    auto const r_ural = fs1.find_last_of(fs2);

    BOOST_CHECK_EQUAL(r_std, r_ural);
}


BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_fail, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "out";
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_pos, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
    ...
    for(auto i : ural::indices_of(fs1))
    {
        auto const r_std = s1.find_last_of(s2, i);
        auto const r_ural = fs1.find_last_of(fs2, i);

        BOOST_CHECK_EQUAL(r_std, r_ural);
    }
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_c_str, String, Strings_list)
{
    std::string s1{"Banana"};
    char const * s2 = "fan";
    ...
    auto const r_std = s1.find_last_of(s2);
    auto const r_ural = fs1.find_last_of(s2);

    BOOST_CHECK_EQUAL(r_std, r_ural);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_pos_c_str, String, Strings_list)
{
    std::string s1{"Banana"};
    char const * s2 = "fan";
    ...
    {
        auto const r_std = s1.find_last_of(s2, i);
        auto const r_ural = fs1.find_last_of(s2, i);

        BOOST_CHECK_EQUAL(r_std, r_ural);
    }
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_char, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_char_pos, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
    ...
    for(auto i : ural::indices_of(fs1))
    {
        auto const r_std = s1.find_last_of(s2[j], i);
        auto const r_ural = fs1.find_last_of(s2[j], i);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_not_of, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
    ...
    auto const r_std = s1.find_last_not_of(s2);
    auto const r_ural = fs1.find_last_not_of(fs2);

    BOOST_CHECK_EQUAL(r_std, r_ural);
}


BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_not_of_fail, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = s1;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_not_of_pos, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
    ...
    for(auto i : ural::indices_of(fs1))
    {
        auto const r_std = s1.find_last_not_of(s2, i);
        auto const r_ural = fs1.find_last_not_of(fs2, i);

        BOOST_CHECK_EQUAL(r_std, r_ural);
    }
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_not_of_c_str, String, Strings_list)
{
    std::string s1{"Banana"};
    char const * s2 = "fan";
    ...
    auto const r_std = s1.find_last_not_of(s2);
    auto const r_ural = fs1.find_last_not_of(s2);

    BOOST_CHECK_EQUAL(r_std, r_ural);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_of_not_pos_c_str, String, Strings_list)
{
    std::string s1{"Banana"};
    char const * s2 = "fan";
    ...
    {
        auto const r_std = s1.find_last_not_of(s2, i);
        auto const r_ural = fs1.find_last_not_of(s2, i);

        BOOST_CHECK_EQUAL(r_std, r_ural);
    }
}

BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_not_of_char, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
...
BOOST_AUTO_TEST_CASE_TEMPLATE(flex_string_find_last_not_of_char_pos, String, Strings_list)
{
    std::string s1{"Banana"};
    std::string s2 = "fan";
    ...
    for(auto i : ural::indices_of(fs1))
    {
        auto const r_std = s1.find_last_not_of(s2[j], i);
        auto const r_ural = fs1.find_last_not_of(s2[j], i);
